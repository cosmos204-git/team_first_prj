...
public class ShowExamItemListDTO {
	...
	public ShowExamItemListDTO(int examCode, int testCode, int examCorrectTChoice, String examChoice1, String examChoice2,
	...
	public String ShowExamItemListToString() {
		return "examItemListDTO [examCode=" + examCode + ", testCode=" + testCode + ", examCorrectTChoice="
				+ examCorrectTChoice + ", examChoice1=" + examChoice1 + ", examChoice2=" + examChoice2
				+ ", examChoice3=" + examChoice3 + ", examChoice4=" + examChoice4 + ", examInputDate=" + examInputDate
				+ ", examQuest=" + examQuest + "]";
	}
