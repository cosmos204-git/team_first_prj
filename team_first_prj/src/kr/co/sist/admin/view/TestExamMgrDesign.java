...
public class TestExamMgrDesign extends JDialog {
	...
	public TestExamMgrDesign(AdminSubjectMgrDesign asmd, boolean modal) {
		...
		jspQuest.setBounds(280,70,200,50);
		jlblExamChoice1.setBounds(230,120,50,20);
		jtfExamChoice1.setBounds(280,120,70,20);
		jlblExamChoice2.setBounds(230,140,50,20);
		jtfExamChoice2.setBounds(280,140,70,20);
		jlblExamChoice3.setBounds(230,160,50,20);
		jtfExamChoice3.setBounds(280,160,70,20);
		jlblExamChoice4.setBounds(230,180,50,20);
		jtfExamChoice4.setBounds(280,180,70,20);
